...
switchMode.addEventListener("change", () => {
  if (mode == 1) 
  {
    ...
    document.querySelector(".To-do-list-group-gray").classList.add("dark-mode-group-gray");
    document.querySelector(".To-do-list-group-white").classList.add("dark-mode-group-white");
    document.querySelector(".To-do-list-text").classList.add("dark-mode-text");
    document.querySelector(".btn-success").classList.add("dark-mode-btn");
    document.querySelector(".To-do-list-check").classList.add("dark-mode-checkBox");
    ...
    document.querySelector(".To-do-list-group-gray").classList.remove("dark-mode-group-gray");
    document.querySelector(".To-do-list-group-white").classList.remove("dark-mode-group-white");
    document.querySelector(".To-do-list-text").classList.remove("dark-mode-text");
    document.querySelector(".btn-success").classList.remove("dark-mode-btn");
